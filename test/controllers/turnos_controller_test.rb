...
class TurnosControllerTest < ActionController::TestCase
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post :create, turno: { hora: @turno.hora, orange: @turno.orange, title: @turno.title, tolerance: @turno.tolerance, type: @turno.type }
    end
  ...
  test "should update turno" do
    patch :update, id: @turno, turno: { hora: @turno.hora, orange: @turno.orange, title: @turno.title, tolerance: @turno.tolerance, type: @turno.type }
    assert_redirected_to turno_path(assigns(:turno))
  end
